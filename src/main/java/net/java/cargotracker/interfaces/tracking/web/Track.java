...
public class Track implements Serializable {
    ...
    private Map<String, String> MaptrackingId;
    ...
    public Map<String, String> getMapTrackingId(){
        return MaptrackingId;
    }
    
    public void setMapTrackingId(){
        Map<String, String> IdMap = new HashMap();
        List<TrackingId> IdList = cargoRepository.getAllTrackingIds();
        
        for(TrackingId vId: IdList){
            IdMap.put(vId.toString(), vId.toString());
        }
     ...
     * @return 
     */
    public Map<String, String> getTrackingIdMap(String query){
        Map<String, String> IdMap = new HashMap();
        List<TrackingId> IdList = cargoRepository.getAllTrackingIds();
